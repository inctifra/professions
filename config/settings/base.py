...
DATABASES = {
    # This database is used for the main application.
    # It is the default database that Django uses.
    "default": env.db(
        # Will be using this for the schema migrations and the main application.
        # It is used for read and write operations.
        "DATABASE_URL",
        default="postgres://localhost/pkenya",
    ),
    # This database is used for read-only access to the cloud database.
    # It is used for fetching data that does not change frequently.
    # This is where the professions data is stored.
    "cloud_readonly": env.db(
        "CLOUD_DATABASE_URL",
        default="postgres://localhost/reader",
    ),
}
...
MIGRATION_MODULES = {"sites": "professions.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "apps.dashboard.context_processors.website_context_processors",
                "apps.analytics.context_processors.compose_analytics_context",
            ],
            "builtins": [
                "apps.dashboard.templatetags.developer",
                "apps.plans.templatetags.plans",
            ],
        },
    },
]
