    ...
    def handle(self, *args, **kwargs):
        ...
        features_data = [
            {
                ...
                "description": "Access to basic professional verification",
                "default_quota": 50,
            },
            {
                "name": "Full Verification",
                "description": "Full verification with detailed report",
                "default_quota": 20,
            },
            {
                "name": "Email Alerts",
                "description": "Receive email notifications on verification",
                "default_quota": 100,
            },
            {
                "name": "API Access",
        ...
        for fdata in features_data:
            feature, created = Feature.objects.get_or_create(
                name=fdata["name"], defaults=fdata
            )
        ...
        for pdata in plans_data:
            plan, created = Plan.objects.get_or_create(
                name=pdata["name"], defaults=pdata
            )
